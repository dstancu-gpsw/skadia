...
import (
	...
	skadiav1alpha1 "github.com/tryggth/schedia/pkg/apis/skadia/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &skadiav1alpha1.Sample{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &skadiav1alpha1.Sample{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSample) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &skadiav1alpha1.Sample{}
...
func newPodForCR(cr *skadiav1alpha1.Sample) *corev1.Pod {
